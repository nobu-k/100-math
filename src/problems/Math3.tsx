...
import FuncLimit from "./math3/FuncLimit";
import DiffApplication from "./math3/DiffApplication";
import IntegralApplication from "./math3/IntegralApplication";
...
export const math3: ProblemGroup = {
  ...
  operators: [
    ...
    { operator: "func-limit", label: "関数の極限", grades: [14], category: "hs-sequence", subcategory: "極限", Component: FuncLimit },
    ...
    { operator: "diff-application", label: "微分の応用", grades: [14], category: "hs-diff", subcategory: "微分法", Component: DiffApplication },
    ...
    { operator: "integral-application", label: "積分の応用", grades: [14], category: "hs-integral", subcategory: "積分法", Component: IntegralApplication },
  ],
};
