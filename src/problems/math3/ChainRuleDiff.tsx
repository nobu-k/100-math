...
import { type FuncType, generateChainRuleDiff } from "./chain-rule-diff";
...
const ChainRuleDiff = () => {
  ...
  const problems = useMemo(() => generateChainRuleDiff(seed, funcType), [seed, funcType]);
