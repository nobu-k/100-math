...
import { DEFAULTS, PARAM_KEYS, frac, updateUrl, generateAdditionProblems } from "./generators";
import "./fraction.css";

const defaults = DEFAULTS.addition;
const minFloor = 2;
const maxCeil = 20;
...
const Addition = () => {
  ...
  const problems = useMemo(
    () => generateAdditionProblems(seed, minDenom, maxDenom),
