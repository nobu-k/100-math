...
export const devGrade5: ProblemGroup = {
  ...
  operators: [
    ...
    { operator: "diff-frac", label: "異分母分数の加減" },
    { operator: "volume", label: "体積" },
    { operator: "circumference", label: "円周" },
    { operator: "even-odd", label: "偶数と奇数" },
    { operator: "frac-compare", label: "分数の大小比較" },
    { operator: "unit-amount", label: "単位量あたり" },
    { operator: "decimal-shift", label: "小数点の移動" },
    { operator: "pattern-eq", label: "きまりの式" },
  ],
  Component: Grade5,
};
