...
const Grade6 = ({ operator }: { operator: string }) => {
  ...
  /* ---- render prism volume SVG ---- */

  const renderPrismVolumeFigure = (p: PrismVolumeProblem) => {
    const W = 200;
    const H = 180;
    const { figure } = p;
...
export const devGrade6: ProblemGroup = {
  ...
  operators: [
    ...
    { operator: "proportion", label: "比例と反比例", grades: [6], category: "relations" },
